...
dashboard_bp = Blueprint("dashboard", __name__, url_prefix="/industry-dashboard")
...
@dashboard_bp.route("/store-monitoring", methods=["GET"])
...
@dashboard_bp.route("/store-monitoring", methods=["POST"])
...
@dashboard_bp.route("/store-monitoring/<device_uuid>", methods=["GET"])
...
@dashboard_bp.route("/device-details/<device_uuid>", methods=["GET"])
...
@dashboard_bp.route("/device-details/<device_uuid>", methods=["POST"])
