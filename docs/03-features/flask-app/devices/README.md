...
| FR-004-1-6 | CSVエクスポート    | 組織のCSVエクスポート        |
...
| ADM-003 | デバイス更新画面 | /admin/devices/<device_uuid>/edit | モーダル | デバイスの更新             |
| ADM-004 | デバイス参照画面 | /admin/devices/<device_uuid>      | モーダル | デバイスの詳細情報表示     |
...
| device_inventory_id         | デバイス在庫ID         | INT          |      | 外部キー： device_inventory_master.device_inventory_id             |
...
| last_received_time | 最終受信時刻 | TIMESTAMP    |       | NULL：テレメトリデータ未受信 　その他の場合：テレメトリデータの最終受信時刻を表示 ※1 |
...
| 6   | デバイス更新画面     | `/admin/devices/<device_uuid>/edit`   | GET      | デバイス更新画面表示        | HTML（モーダル）   |
| 7   | デバイス更新実行     | `/admin/devices/<device_uuid>/update` | POST     | デバイス更新処理            | リダイレクト (302) |
| 8   | デバイス削除実行     | `/admin/devices/delete`               | POST     | デバイス削除処理            | リダイレクト (302) |
| 9   | CSVエクスポート      | `/admin/devices/export`               | POST     | デバイス一覧CSVダウンロード | CSV                |
